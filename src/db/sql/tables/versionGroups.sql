...
CREATE TABLE IF NOT EXISTS pdescription_ability (
  ...
  PRIMARY KEY (ability_generation_id, ability_id, version_group_id, pdescription_id),
...
CREATE TABLE IF NOT EXISTS pdescription_pmove (
  ...
  PRIMARY KEY (pmove_generation_id, pmove_id, version_group_id, pdescription_id),
...
CREATE TABLE IF NOT EXISTS pdescription_item (
  ...
  PRIMARY KEY (item_generation_id, item_id, version_group_id, pdescription_id),
...
CREATE TABLE IF NOT EXISTS sprite_pokemon (
  ...
  PRIMARY KEY (pokemon_generation_id, pokemon_id, version_group_id, sprite_id),
...
CREATE TABLE IF NOT EXISTS sprite_item (
  ...
  PRIMARY KEY (item_generation_id, item_id, version_group_id, sprite_id),
  FOREIGN KEY (item_generation_id, item_id) REFERENCES item(generation_id, item_id)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  FOREIGN KEY (version_group_id) REFERENCES version_group(version_group_id)
